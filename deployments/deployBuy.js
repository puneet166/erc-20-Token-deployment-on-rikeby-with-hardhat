...
const main = async ()=>{
    ...
    const Buy = await ethers.getContractFactory("BuyNFT");
    console.log("deploy Buy",Buy)

    const buy = await upgrades.deployProxy(Buy, [10,"0xd55afcf4E872579CC6C0A8Cc3aa1950cC5237945"]  ,{ initializer: 'initialize' });
